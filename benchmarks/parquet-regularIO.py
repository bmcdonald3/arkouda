...
if __name__ == "__main__":
    ...
    if args.only_write:
        time_ak_write(args.size, args.trials, args.dtype, args.path, args.seed, True)
    elif args.only_read:
        time_ak_read(args.size, args.trials, args.dtype, args.path, args.seed, True)
    else:
        time_ak_write(args.size, args.trials, args.dtype, args.path, args.seed, True)
        time_ak_read(args.size, args.trials, args.dtype, args.path, args.seed, True)
