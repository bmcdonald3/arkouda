...
module RadixSortLSD
{
    ...
    proc radixSortLSD(a:[?aD] ?t, checkSorted: bool = true): [aD] (t, int) throws {
        var kr = aD.tryCreateArray((t,int));
